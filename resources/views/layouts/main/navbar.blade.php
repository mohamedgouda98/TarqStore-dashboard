    ...
    <header class="header navbar navbar-expand-sm">
        ...
        <ul class="navbar-item flex-row ml-md-auto">
            ...
            <li class="nav-item dropdown language-dropdown">
                <a href="{{LaravelLocalization::getLocalizedURL('en')}}" class="nav-link dropdown-toggle" id="language-dropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <img src="{{asset('AdminAssets/assets/img/ca.png')}}" class="flag-width" alt="flag">
                </a>
                <div class="dropdown-menu position-absolute" aria-labelledby="language-dropdown">
                    <a class="dropdown-item d-flex" href="{{LaravelLocalization::getLocalizedURL('en')}}"><img src="{{asset('AdminAssets/assets/img/ar.png')}}" class="flag-width" alt="flag"> <span class="align-self-center">&nbsp;English</span></a>
                    <a class="dropdown-item d-flex" href="{{LaravelLocalization::getLocalizedURL('ar')}}"><img src="{{asset('AdminAssets/assets/img/ar.png')}}" class="flag-width" alt="flag"> <span class="align-self-center">&nbsp;Arabic</span></a>
                </div>
            </li>
            ...
            <ul class="list-unstyled menu-categories" id="accordionExample">
                <li class="menu">
                    ...
                    <ul class="collapse submenu list-unstyled show" id="dashboard" data-parent="#accordionExample">
                        ...
                        <li>
                            <a href="{{ route('admin.blog.category.index') }}"> Show </a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="menu">
                    ...
                    <ul class="collapse submenu list-unstyled show" id="dashboard" data-parent="#accordionExample">
                        ...
                        <li>
                            <a href="{{ route('admin.blog.index') }}"> Show </a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="menu">
                    ...
                    <ul class="collapse submenu list-unstyled show" id="dashboard" data-parent="#accordionExample">
                        ...
                        <li>
                            <a href="{{ route('admin.product.index') }}"> Show </a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="menu">
                    ...
                    <ul class="collapse submenu list-unstyled show" id="dashboard" data-parent="#accordionExample">
                        ...
                        <li>
                            <a href="{{ route('admin.coupon.index') }}"> Show </a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="menu">
                    ...
                    <ul class="collapse submenu list-unstyled show" id="dashboard" data-parent="#accordionExample">
                        ...
                        <li>
                            <a href="{{ route('admin.permission.index') }}"> Show </a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="menu">
                    ...
                    <ul class="collapse submenu list-unstyled show" id="dashboard" data-parent="#accordionExample">
                        ...
                        <li>
                            <a href="{{ route('admin.role.index') }}"> Show </a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="menu">
                    ...
                    <ul class="collapse submenu list-unstyled show" id="dashboard" data-parent="#accordionExample">
                        <li class="active">
                            <a href="{{ route('admin.setting.create')}}"> Create </a>
                        </li>
                        <li>
                            <a href="{{ route('admin.setting.index') }}"> Show </a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="menu">
                    ...
                    <ul class="collapse submenu list-unstyled show" id="dashboard" data-parent="#accordionExample">
                        <li class="active">
                            <a href="{{ route('admin.ads.create')}}"> Create </a>
                        </li>
                        <li>
                            <a href="{{ route('admin.ads.index') }}"> Show </a>
                        </li>
                    </ul>
                </li>
