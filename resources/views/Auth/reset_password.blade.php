            ...
            <div class="form-form-wrap">
                <div class="form-container">
                    <div class="form-content">
                        ...
                        <form class="text-left" method="post" action="{{route('reset_password.action', request()->query())}}">
                            @csrf
                            <div class="form">
                                ...
                                <div id="username-field" class="field-wrapper input">
                                    ...
                                    <input id="email" name="email" type="text" class="form-control" placeholder="e.g dev@gmail.com">
                                    @error('email')
